...
const Footer = () => {
  return (
    <Slide direction="up" duration={1200} triggerOnce>
      <div className="bg-base-200 text-base-content p-10 relative overflow-hidden">
        ...
        <div className="container mx-auto z-10">
              ...
              <ul className="space-y-3">
                <li>
                  <p className="flex items-center justify-center sm:justify-start">
                    <span className="mr-2">📍</span> 123 Flavor Ave, Foodville,
                    TX 54321
                  </p>
                </li>
                <li>
          ...
          <div className="mt-12 pt-8 border-t border-base-300 text-center">
            ...
            <p className="text-sm text-base-content">
              &copy; {new Date().getFullYear()} TasteTribe Interactive All
              Rights Reserved
            </p>
          </div>
        </div>
